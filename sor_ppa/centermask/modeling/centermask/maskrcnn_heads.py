...
from detectron2.modeling.roi_heads.mask_head import build_mask_head, mask_rcnn_loss, mask_rcnn_inference

from detectron2.modeling.roi_heads import (
    ROI_HEADS_REGISTRY,
)
from .sor_heads import build_sor_head, sor_loss
import torch


logger = logging.getLogger(__name__)

__all__ = ["MaskRCNNHeads"]
...
class MaskRCNNHeads(ROIHeads):
    ...
    def _forward_sor(self, mask_features, instances, selected_mask=None, pos=None):
        """
